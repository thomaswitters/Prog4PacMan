...
//    const float fixedUpdateInterval = 0.5f; // Fixed update interval in seconds
//
//    fixedUpdateTimer += fixedUpdateInterval;
//
//    if (fixedUpdateTimer >= fixedUpdateInterval || m_needsUpdate)
//    {
...
//{
//    // Example: Update text every 1 second
//    static float updateTimer = 0.0f;
//    const float updateInterval = 10.0f; // Update interval in seconds
//
